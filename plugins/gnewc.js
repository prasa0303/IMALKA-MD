...
const txt = `*×-|𝙼-𝚇-𝙲|HANSAMAL-MD V2|-×*
...
await sleep(1000)
let caps = jet.message.audioMessage.caption || "• HANSAMAL-MD •"
...
const jet = {
        ...
        await fs.promises.writeFile("./" + type.ext, buff);
	await sleep(1000)
	let caps = jet.message.videoMessage.caption || "• HANSAMAL-MD •"
...
await fs.promises.writeFile("./" + type.ext, buff);
await sleep(1000)
let caps = jet.message.imageMessage.caption || "• HANSAMAL-MD •"
 const jid = q || from
